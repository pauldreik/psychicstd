#!/usr/bin/env python3
"""
Compares two focused compile-time result files (from
benchmark_compile_time.py --json) and
...
Usage:
  scripts/_benchmark_diff.py --base base.json --head head.json [--threshold 5]
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description=(
            ...
            "Each input is JSON generated by `benchmark_compile_time.py --json`: run "
    ...
    ap.add_argument(
        ...
        required=True,
        metavar="JSON",
        help="baseline results from `benchmark_compile_time.py --json`",
    )
    ap.add_argument(
        "--head",
        required=True,
        metavar="JSON",
        help="new results from `benchmark_compile_time.py --json`",
    )
    ap.add_argument(
        "--threshold",
        type=float,
