...
| --- | ---: | ---: | ---: | --- |
| configure | 0.48 | 0.47 | 🟢 1.00x [1.00x, 1.02x] | |
| compile | 17.13 | 7.31 | 🟢 2.35x [2.33x, 2.35x] | |
| run tests | 0.10 | 0.08 | 🟢 1.20x [1.20x, 1.21x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.48 | 0.47 | 🟢 1.01x [1.00x, 1.01x] | |
| compile | 29.79 | 23.05 | 🟢 1.29x [1.29x, 1.30x] | |
| run tests | 0.03 | 0.03 | 🔴 0.88x [0.87x, 0.90x] | |
