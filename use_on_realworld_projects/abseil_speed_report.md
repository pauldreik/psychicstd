...
| --- | ---: | ---: | ---: | --- |
| configure | 1.31 | 1.31 | 🟡 1.00x [0.97x, 1.03x] | |
| compile | 3.83 | 1.80 | 🟢 2.12x [2.07x, 2.17x] | |
| run tests | 0.28 | 0.16 | 🟢 1.71x [1.69x, 1.76x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 1.35 | 1.34 | 🟡 1.01x [1.00x, 1.02x] | |
| compile | 6.84 | 5.53 | 🟢 1.24x [1.23x, 1.25x] | |
| run tests | 0.05 | 0.06 | 🔴 0.81x [0.79x, 0.84x] | |
