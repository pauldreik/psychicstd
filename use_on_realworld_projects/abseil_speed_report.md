...
| --- | ---: | ---: | ---: | --- |
| configure | 1.25 | 1.25 | 🟡 1.00x [0.99x, 1.02x] | |
| compile | 3.73 | 1.75 | 🟢 2.13x [2.11x, 2.17x] | |
| run tests | 0.28 | 0.17 | 🟢 1.60x [1.56x, 1.64x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 1.25 | 1.25 | 🟡 1.00x [0.99x, 1.01x] | |
| compile | 6.64 | 5.34 | 🟢 1.24x [1.23x, 1.25x] | |
| run tests | 0.04 | 0.06 | 🔴 0.80x [0.79x, 0.82x] | |
