...
Parallelism: **8 jobs** (16 logical CPUs available; the memory estimate permits 14 jobs at 1.5 GiB/job). ccache was disabled.
...
| --- | ---: | ---: | ---: | --- |
| configure | 1.41 | 1.41 | 🟡 1.00x [0.98x, 1.03x] | |
| compile | 3.95 | 1.85 | 🟢 2.13x [2.09x, 2.19x] | |
| run tests | 0.28 | 0.18 | 🟢 1.58x [1.47x, 1.66x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 1.39 | 1.39 | 🟡 1.00x [0.99x, 1.03x] | |
| compile | 7.06 | 5.60 | 🟢 1.26x [1.23x, 1.27x] | |
| run tests | 0.05 | 0.06 | 🔴 0.81x [0.80x, 0.82x] | |
