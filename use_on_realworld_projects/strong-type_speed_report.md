...
| compile | 9.55 | 2.73 | 🟢 3.50x [3.46x, 3.54x] | |
| run tests | 0.00 | 0.00 | 🟢 1.45x [1.42x, 1.53x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.32 | 0.33 | 🟡 1.00x [0.98x, 1.01x] | |
| compile | 13.57 | 7.39 | 🟢 1.84x [1.83x, 1.86x] | |
| run tests | 0.00 | 0.00 | 🟢 1.15x [1.05x, 1.23x] | |
