...
| --- | ---: | ---: | ---: | --- |
| configure | 17.33 | 17.24 | 🟡 1.01x | |
| compile | 65.63 | 36.62 | 🟡 1.79x | |
| run tests | 499.45 | 494.24 | 🟡 1.01x | |

______________________________________________________________________

Reproduce this on your machine: `scripts/compare_realworld_performance.py --compiler c++ --build-type debug --reps 1 --jobs 8`
