...
| --- | ---: | ---: | ---: | --- |
| compile | 16.13 | 4.69 | 🟢 3.44x [3.39x, 3.55x] | |
| run tests | 2.02 | 1.65 | 🟢 1.23x [1.20x, 1.25x] | the approval tests are ignored |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 20.18 | 14.06 | 🟢 1.44x [1.43x, 1.44x] | |
| run tests | 1.53 | 1.52 | 🟡 1.01x [1.00x, 1.01x] | the approval tests are ignored |
