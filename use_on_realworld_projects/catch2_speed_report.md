...
| --- | ---: | ---: | ---: | --- |
| compile | 15.91 | 4.57 | 🟢 3.48x [3.42x, 3.53x] | |
| run tests | 1.99 | 1.68 | 🟢 1.19x [1.17x, 1.22x] | the approval tests are ignored |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 20.08 | 13.79 | 🟢 1.46x [1.45x, 1.46x] | |
| run tests | 1.54 | 1.52 | 🟢 1.01x [1.00x, 1.02x] | the approval tests are ignored |
