...
| --- | ---: | ---: | ---: | --- |
| compile | 16.30 | 4.59 | 🟢 3.55x [3.51x, 3.58x] | |
| run tests | 1.99 | 1.63 | 🟢 1.22x [1.19x, 1.25x] | the approval tests are ignored |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 20.49 | 14.05 | 🟢 1.46x [1.45x, 1.46x] | |
| run tests | 1.57 | 1.55 | 🟡 1.02x [1.00x, 1.02x] | the approval tests are ignored |
