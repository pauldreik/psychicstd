...
| --- | ---: | ---: | ---: | --- |
| compile | 16.18 | 4.80 | 🟢 3.37x [3.32x, 3.43x] | |
| run tests | 1.60 | 1.54 | 🟢 1.04x [1.02x, 1.06x] | the approval tests are ignored |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 20.32 | 14.29 | 🟢 1.42x [1.42x, 1.43x] | |
| run tests | 1.44 | 1.39 | 🟢 1.04x [1.00x, 1.05x] | the approval tests are ignored |
