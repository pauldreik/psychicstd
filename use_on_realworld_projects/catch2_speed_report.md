...
| --- | ---: | ---: | ---: | --- |
| compile | 16.02 | 5.00 | 🟢 3.20x [3.16x, 3.28x] | |
| run tests | 2.00 | 1.63 | 🟢 1.23x [1.20x, 1.29x] | the approval tests are ignored |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 20.17 | 11.52 | 🟢 1.75x [1.74x, 1.77x] | |
| run tests | 1.52 | 1.54 | 🟡 0.99x [0.96x, 1.00x] | the approval tests are ignored |
