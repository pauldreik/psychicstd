...
| --- | ---: | ---: | ---: | --- |
| configure | 24.03 | 24.03 | 🟡 1.00x [1.00x, 1.00x] | |
...
| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 24.04 | 24.04 | 🟡 1.00x [1.00x, 1.00x] | |
| compile | 3.06 | 1.45 | 🟢 2.11x [2.11x, 2.12x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
| run tests | 8.01 | 8.01 | 🟢 1.00x [1.00x, 1.00x] | |
