...
| --- | ---: | ---: | ---: | --- |
| configure | 24.11 | 24.10 | 🟡 1.00x [1.00x, 1.00x] | |
| compile | 3.07 | 1.47 | 🟢 2.08x [2.08x, 2.09x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
...
| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 24.14 | 24.14 | 🟡 1.00x [1.00x, 1.01x] | |
| compile | 3.08 | 1.48 | 🟢 2.08x [2.07x, 2.09x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
| run tests | 8.01 | 8.01 | 🟢 1.00x [1.00x, 1.00x] | |
