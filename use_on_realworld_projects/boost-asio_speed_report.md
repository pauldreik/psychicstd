...
| --- | ---: | ---: | ---: | --- |
| configure | 25.13 | 24.99 | 🟡 1.01x [1.00x, 1.01x] | |
| compile | 3.21 | 1.52 | 🟢 2.11x [2.07x, 2.12x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
...
| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 24.99 | 24.99 | 🟡 1.00x [1.00x, 1.00x] | |
| compile | 3.20 | 1.52 | 🟢 2.10x [2.08x, 2.12x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
| run tests | 8.01 | 8.01 | 🟢 1.00x [1.00x, 1.00x] | |
