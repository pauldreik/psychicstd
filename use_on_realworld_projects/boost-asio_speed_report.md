...
| --- | ---: | ---: | ---: | --- |
| configure | 24.15 | 24.16 | 🟡 1.00x [1.00x, 1.00x] | |
| compile | 3.09 | 1.44 | 🟢 2.14x [2.13x, 2.14x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
...
| --- | ---: | ---: | ---: | --- |
| configure | 24.15 | 24.16 | 🟡 1.00x [1.00x, 1.00x] | |
| compile | 3.08 | 1.44 | 🟢 2.13x [2.12x, 2.14x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
| run tests | 8.01 | 8.01 | 🟢 1.00x [1.00x, 1.00x] | |
