...
| --- | ---: | ---: | ---: | --- |
| configure | 26.39 | 26.42 | 🟡 1.00x [0.99x, 1.00x] | |
| compile | 3.37 | 1.60 | 🟢 2.11x [2.09x, 2.12x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
...
| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 26.31 | 26.37 | 🟡 1.00x [0.92x, 1.08x] | |
| compile | 3.34 | 1.59 | 🟢 2.09x [1.94x, 2.27x] | Representative upstream Asio tests are compiled and linked directly; unrelated Boost libraries are excluded. |
| run tests | 8.01 | 8.01 | 🟢 1.00x [1.00x, 1.00x] | |
