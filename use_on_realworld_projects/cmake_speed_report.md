...
| --- | ---: | ---: | ---: | --- |
| configure | 21.27 | 18.55 | 🟢 1.15x [1.13x, 1.16x] | |
| compile | 92.06 | 30.19 | 🟢 3.05x [3.03x, 3.09x] | |
| run tests | 1.17 | 1.17 | 🟢 1.00x [1.00x, 1.00x] | |

______________________________________________________________________

Reproduce this on your machine: `scripts/compare_realworld_performance.py --compiler c++ --build-type debug --reps 4 --jobs 8`
