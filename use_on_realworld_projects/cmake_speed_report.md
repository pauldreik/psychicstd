...
| --- | ---: | ---: | ---: | --- |
| configure | 19.79 | 18.63 | 🟢 1.06x [1.05x, 1.08x] | |
| compile | 105.33 | 34.44 | 🟢 3.06x [3.02x, 3.11x] | |
...
| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 19.74 | 18.65 | 🟢 1.06x [1.04x, 1.08x] | |
| compile | 108.70 | 56.22 | 🟢 1.93x [1.93x, 1.95x] | |
| run tests | 1.16 | 1.16 | 🟡 1.00x [1.00x, 1.00x] | |
