...
| compile | 11.34 | 9.32 | 🟢 1.22x [1.20x, 1.23x] | |
| run example | 0.00 | 0.00 | 🟢 1.61x [1.44x, 2.14x] | |
| run tests | 2.22 | 2.29 | 🔴 0.97x [0.95x, 0.98x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.43 | 0.44 | 🟡 0.99x [0.98x, 1.01x] | |
| compile | 44.10 | 45.40 | 🔴 0.97x [0.97x, 0.97x] | |
| run example | 0.00 | 0.00 | 🟢 1.67x [1.53x, 1.89x] | |
| run tests | 0.34 | 0.33 | 🟢 1.03x [1.03x, 1.04x] | |
