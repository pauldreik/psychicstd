...
| --- | ---: | ---: | ---: | --- |
| configure | 0.43 | 0.42 | 🟢 1.01x [1.00x, 1.02x] | |
| compile | 11.29 | 9.06 | 🟢 1.25x [1.24x, 1.25x] | |
| run example | 0.00 | 0.00 | 🟢 1.38x [1.34x, 1.55x] | |
| run tests | 2.20 | 2.24 | 🟡 0.99x [0.98x, 1.00x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.42 | 0.42 | 🟡 1.01x [1.00x, 1.02x] | |
| compile | 43.90 | 45.01 | 🔴 0.98x [0.97x, 0.98x] | |
| run example | 0.00 | 0.00 | 🟢 1.83x [1.59x, 1.93x] | |
| run tests | 0.34 | 0.33 | 🟢 1.02x [1.00x, 1.03x] | |
