...
| --- | ---: | ---: | ---: | --- |
| configure | 0.46 | 0.46 | 🟡 1.00x [0.98x, 1.01x] | |
| compile | 11.49 | 9.70 | 🟢 1.18x [1.17x, 1.20x] | |
| run example | 0.00 | 0.00 | 🟢 1.72x [1.51x, 1.98x] | |
| run tests | 2.21 | 2.21 | 🟡 1.00x [0.99x, 1.01x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.46 | 0.46 | 🟡 1.01x [0.99x, 1.02x] | |
| compile | 45.64 | 46.99 | 🔴 0.97x [0.96x, 0.98x] | |
| run example | 0.00 | 0.00 | 🟢 1.51x [1.31x, 1.83x] | |
| run tests | 0.33 | 0.33 | 🟡 1.01x [0.99x, 1.02x] | |
