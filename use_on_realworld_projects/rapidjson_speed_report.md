...
| compile | 11.28 | 9.02 | 🟢 1.25x [1.24x, 1.25x] | |
| run example | 0.00 | 0.00 | 🟢 1.63x [1.56x, 1.89x] | |
| run tests | 2.22 | 2.25 | 🟡 0.99x [0.97x, 1.00x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.43 | 0.43 | 🟡 0.99x [0.99x, 1.01x] | |
| compile | 43.85 | 44.90 | 🔴 0.98x [0.97x, 0.98x] | |
| run example | 0.00 | 0.00 | 🟢 1.45x [1.39x, 1.67x] | |
| run tests | 0.34 | 0.33 | 🟡 1.01x [1.00x, 1.02x] | |
