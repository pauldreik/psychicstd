...
| --- | ---: | ---: | ---: | --- |
| configure | 0.44 | 0.44 | 🟡 1.01x [1.00x, 1.03x] | |
| compile | 11.30 | 9.10 | 🟢 1.24x [1.23x, 1.26x] | |
| run example | 0.00 | 0.00 | 🟢 1.55x [1.28x, 1.81x] | |
| run tests | 2.22 | 2.23 | 🟡 0.99x [0.98x, 1.00x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.44 | 0.44 | 🟡 0.99x [0.98x, 1.01x] | |
| compile | 43.85 | 45.05 | 🔴 0.97x [0.97x, 0.98x] | |
| run example | 0.00 | 0.00 | 🟢 1.59x [1.33x, 1.96x] | |
| run tests | 0.34 | 0.34 | 🟡 1.00x [0.95x, 1.01x] | |
