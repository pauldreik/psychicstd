...
| --- | ---: | ---: | ---: | --- |
| compile | 22.94 | 11.83 | 🟢 1.94x [1.92x, 1.96x] | |
| run tests | 42.76 | 42.75 | 🟡 1.00x [1.00x, 1.01x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 22.96 | 11.94 | 🟢 1.92x [1.91x, 1.95x] | |
| run tests | 42.91 | 42.92 | 🟡 1.00x [0.99x, 1.01x] | |
