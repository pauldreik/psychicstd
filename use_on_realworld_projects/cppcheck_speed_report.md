...
| --- | ---: | ---: | ---: | --- |
| compile | 23.15 | 11.61 | 🟢 1.99x [1.95x, 2.01x] | |
| run tests | 43.87 | 40.49 | 🟢 1.08x [1.08x, 1.09x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 23.17 | 11.66 | 🟢 1.99x [1.97x, 2.02x] | |
| run tests | 43.99 | 40.31 | 🟢 1.09x [1.09x, 1.10x] | |
