...
| --- | ---: | ---: | ---: | --- |
| compile | 22.93 | 11.44 | 🟢 2.00x [1.96x, 2.03x] | |
| run tests | 43.95 | 38.05 | 🟢 1.16x [1.15x, 1.16x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 22.93 | 11.50 | 🟢 1.99x [1.97x, 2.00x] | |
| run tests | 43.89 | 37.87 | 🟢 1.16x [1.16x, 1.16x] | |
