...
Compiles pocketfft's demonstration program without running its long FFT workload.

### Debug

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 1.97 | 1.24 | 🟢 1.59x [1.58x, 1.59x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 1.97 | 1.25 | 🟢 1.58x [1.57x, 1.60x] | |
