...
| --- | ---: | ---: | ---: | --- |
| compile | 1.90 | 1.24 | 🟢 1.54x [1.54x, 1.55x] | |
| run tests | 127.28 | 124.51 | 🟢 1.02x [1.01x, 1.04x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 1.91 | 1.23 | 🟢 1.55x [1.54x, 1.55x] | |
| run tests | 127.73 | 124.24 | 🟢 1.03x [1.02x, 1.04x] | |
