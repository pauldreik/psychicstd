...
| --- | ---: | ---: | ---: | --- |
| compile | 1.90 | 1.23 | 🟢 1.54x [1.54x, 1.55x] | |
| run tests | 127.47 | 125.49 | 🟢 1.02x [1.01x, 1.03x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 1.90 | 1.23 | 🟢 1.54x [1.53x, 1.54x] | |
| run tests | 125.82 | 126.44 | 🟡 1.00x [0.98x, 1.01x] | |
