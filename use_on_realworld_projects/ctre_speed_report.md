...
Parallelism: **8 jobs** (20 logical CPUs available; the memory estimate permits 24 jobs at 1.5 GiB/job). ccache was disabled.

## ctre (3.11.0)

Builds every upstream CTRE compile-time test.

### Debug

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 3.88 | 3.42 | 🟢 1.13x [1.11x, 1.16x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| compile | 3.65 | 3.28 | 🟢 1.11x [1.06x, 1.15x] | |
