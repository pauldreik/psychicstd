...
| --- | ---: | ---: | ---: | --- |
| configure | 0.56 | 0.54 | 🟢 1.02x [1.01x, 1.03x] | |
| compile | 17.10 | 10.99 | 🟢 1.56x [1.55x, 1.57x] | |
...
| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.55 | 0.55 | 🟡 1.00x [0.99x, 1.01x] | |
| compile | 38.72 | 41.50 | 🔴 0.93x [0.93x, 0.93x] | |
| run tests | 2.06 | 2.07 | 🟡 1.00x [1.00x, 1.00x] | |
