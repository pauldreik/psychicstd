...
Parallelism: **4 jobs** (20 logical CPUs available; the memory estimate permits 16 jobs at 1.5 GiB/job). ccache was disabled.
...
| --- | ---: | ---: | ---: | --- |
| compile | 4.53 | 2.85 | 🟢 1.59x [1.58x, 1.60x] | |
| run tests | 0.01 | 0.01 | 🟢 1.28x [1.22x, 1.34x] | |
