...
| --- | ---: | ---: | ---: | --- |
| configure | 1.11 | 0.98 | 🟢 1.13x [1.11x, 1.16x] | |
| compile | 0.95 | 0.22 | 🟢 4.30x [4.18x, 4.39x] | |
| run tests | 2.49 | 1.42 | 🟢 1.75x [1.74x, 1.79x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 1.15 | 1.02 | 🟢 1.13x [1.11x, 1.14x] | |
| compile | 1.19 | 0.42 | 🟢 2.81x [2.74x, 2.86x] | |
| run tests | 2.51 | 1.43 | 🟢 1.75x [1.72x, 1.81x] | |
