...
| --- | ---: | ---: | ---: | --- |
| configure | 1.09 | 0.97 | 🟢 1.12x [1.09x, 1.15x] | |
| compile | 0.90 | 0.22 | 🟢 4.17x [4.08x, 4.23x] | |
| run tests | 2.56 | 1.43 | 🟢 1.80x [1.78x, 1.86x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 1.11 | 0.98 | 🟢 1.13x [1.11x, 1.15x] | |
| compile | 1.12 | 0.41 | 🟢 2.71x [2.68x, 2.73x] | |
| run tests | 2.55 | 1.37 | 🟢 1.86x [1.81x, 1.89x] | |
