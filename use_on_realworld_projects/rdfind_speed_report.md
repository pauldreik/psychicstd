...
| --- | ---: | ---: | ---: | --- |
| configure | 1.10 | 0.97 | 🟢 1.13x [1.10x, 1.14x] | |
| compile | 0.89 | 0.22 | 🟢 4.12x [4.01x, 4.20x] | |
| run tests | 2.59 | 1.42 | 🟢 1.82x [1.81x, 1.89x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 1.12 | 0.99 | 🟢 1.12x [1.11x, 1.16x] | |
| compile | 1.12 | 0.44 | 🟢 2.53x [2.49x, 2.54x] | |
| run tests | 2.59 | 1.41 | 🟢 1.83x [1.82x, 1.91x] | |
