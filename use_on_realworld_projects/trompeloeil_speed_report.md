...
| --- | ---: | ---: | ---: | --- |
| configure | 0.44 | 0.42 | 🟢 1.05x [1.01x, 1.06x] | |
| compile | 23.77 | 14.68 | 🟢 1.62x [1.61x, 1.63x] | |
| run tests | 1.84 | 1.50 | 🟢 1.22x [1.19x, 1.26x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.43 | 0.42 | 🟢 1.03x [1.01x, 1.06x] | |
| compile | 41.52 | 38.16 | 🟢 1.09x [1.08x, 1.09x] | |
| run tests | 0.72 | 0.62 | 🟢 1.15x [1.13x, 1.19x] | |
