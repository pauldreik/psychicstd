...
| --- | ---: | ---: | ---: | --- |
| configure | 0.42 | 0.40 | 🟢 1.04x [1.02x, 1.06x] | |
| compile | 23.29 | 14.50 | 🟢 1.61x [1.60x, 1.61x] | |
| run tests | 1.78 | 1.46 | 🟢 1.22x [1.20x, 1.26x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.42 | 0.41 | 🟢 1.04x [1.03x, 1.05x] | |
| compile | 40.35 | 37.30 | 🟢 1.08x [1.08x, 1.08x] | |
| run tests | 0.70 | 0.58 | 🟢 1.19x [1.15x, 1.21x] | |
