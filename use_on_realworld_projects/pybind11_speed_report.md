...
| compile | 2.74 | 1.14 | 🟢 2.41x [2.38x, 2.43x] | |
| run tests | 0.01 | 0.01 | 🟢 1.08x [1.06x, 1.11x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.39 | 0.38 | 🟡 1.01x [1.00x, 1.02x] | |
| compile | 3.16 | 1.69 | 🟢 1.87x [1.86x, 1.89x] | |
| run tests | 0.01 | 0.01 | 🟢 1.05x [1.03x, 1.09x] | |
