...
Parallelism: **4 jobs** (20 logical CPUs available; the memory estimate permits 23 jobs at 1.5 GiB/job). ccache was disabled.
...
| compile | 2.68 | 1.13 | 🟢 2.37x [2.33x, 2.39x] | |
| run tests | 0.01 | 0.01 | 🟢 1.09x [1.07x, 1.11x] | |
