...
| --- | ---: | ---: | ---: | --- |
| configure | 0.39 | 0.39 | 🟡 1.00x [0.98x, 1.02x] | |
| compile | 2.84 | 1.20 | 🟢 2.38x [2.35x, 2.40x] | |
| run tests | 0.01 | 0.01 | 🟢 1.06x [1.00x, 1.27x] | |

### Release

| step | system (s) | psychicstd (s) | speedup | comment |
| --- | ---: | ---: | ---: | --- |
| configure | 0.39 | 0.39 | 🟡 1.01x [0.99x, 1.03x] | |
| compile | 3.25 | 1.95 | 🟢 1.66x [1.65x, 1.68x] | |
| run tests | 0.01 | 0.01 | 🟡 1.04x [0.97x, 1.06x] | |
