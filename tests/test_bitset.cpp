...
int main() {
  ...
  psyassert((text_bits & std::bitset<6>(15)) == std::bitset<6>(10));
  psyassert((text_bits | std::bitset<6>(21)) == std::bitset<6>(63));
  psyassert((text_bits ^ std::bitset<6>(15)) == std::bitset<6>(37));
